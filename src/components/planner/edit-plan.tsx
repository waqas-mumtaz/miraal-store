    ...
    const fetchPlan = async () => {
      try {
        ...
        setFormData({
          ...
          vat: plan.ebayDetails?.vat?.toString() || "0",
          ebayCommission: plan.ebayDetails?.ebayCommission?.toString() || "15",
          advertisingPercentage: plan.ebayDetails?.advertisingPercentage?.toString() || "0",
          fulfillmentCost: plan.amazonDetails?.fulfillmentCost?.toString() || "0",
          feePerItem: plan.amazonDetails?.feePerItem?.toString() || "0",
          storageFees: plan.amazonDetails?.storageFees?.toString() || "0",
          shippingCharges: plan.shippingCharges.toString(),
          shippingCost: plan.shippingCost.toString(),
          status: plan.status,
