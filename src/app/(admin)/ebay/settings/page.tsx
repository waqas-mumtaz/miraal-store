        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-500">Connect your eBay account to sync orders and manage listings</p>
            </div>
            <div className="text-sm text-gray-500">
              Status will be shown above
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Additional eBay configuration options will be available here in future updates.
          </p>
        </div>
      </div>
    </div>
